...
export default class Germs extends Phaser.Physics.Arcade.Group {
  ...
  start() {
    const germ1 = new Germ(this.scene, 100, 100, 'germ1');
    const germ2 = new Germ(this.scene, 700, 600, 'germ1');
    const germ3 = new Germ(this.scene, 200, 400, 'germ1');
    ...
    this.timedEvent = this.scene.time.addEvent({
      delay: 2000, callback: this.releaseGerm, callbackScope: this, loop: true,
    });
  }
